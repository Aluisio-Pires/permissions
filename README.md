...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/aluisio-pires/permissions.svg?style=flat-square)](https://packagist.org/packages/aluisio-pires/permissions)
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/aluisio-pires/permissions/run-tests-L8.yml?branch=main&label=Tests)](https://github.com/aluisio-pires/permissions/actions?query=workflow%3ATests+branch%3Amain)
[![Total Downloads](https://img.shields.io/packagist/dt/aluisio-pires/permissions.svg?style=flat-square)](https://packagist.org/packages/aluisio-pires/permissions)
